					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb pull-right">
								...
								<li class="active">Search Problem</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Search Problem</h3>
								</div>
														...
														<table id="datatable"
															...
															<thead>
																<tr role="row">
																	...
																	<th class="sorting" tabindex="0"
																		...
																		style="width: 300px;">Problem Name</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Office: activate to sort column ascending"
																		style="width: 114px;">Category</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Age: activate to sort column ascending"
																		style="width: 57px;">Type</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																	...
																	<th class="sorting" tabindex="0"
																		...
																		style="width: 70px;">Marks</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Salary: activate to sort column ascending"
																		style="width: 86px;">Operation</th>
																</tr>
															</thead>
															<tbody>
															<c:forEach items="${listProblem}" var="listproblem">
																<tr role="row" class="odd">
																	...
																	<td class="sorting_1 ">${listproblem.problemID}</td>
																	<td><a href="${pageContext.request.contextPath }/viewProblem.htm?problemID=${listproblem.problemID}">${listproblem.problemName}</a></td>
																	
																	<td>${listproblem.categoryModel.categoryName }</td>
																	<td>${listproblem.problemType }</td>
																	<td>${listproblem.problemDate }</td>
																	<td>${listproblem.problemMarks }</td>
																	<td>
																		<a href="${pageContext.request.contextPath }/editProblem.htm?problemID=${listproblem.problemID }">
																			<i class="md md-create"></i>
																		</a>
																		<a href="${pageContext.request.contextPath }/deleteProblem.htm?problemID=${listproblem.problemID }">
