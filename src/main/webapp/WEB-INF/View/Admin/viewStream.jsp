						...
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">	
									<h3 class="panel-title">View Stream</h3>
								</div>
												...
												<div class="row">
													<div class="col-sm-12">
														<table id="datatable"
															...
															<thead>
																<tr role="row">
																	...
																	<th class="sorting" tabindex="0"
																		...
																		style="width: 100px;">Stream Name</th>
															...
															<tbody>
													<c:forEach items="${listStream}" var="liststream">
																<tr role="row" class="odd">
																	<td class="sorting_1 ">${liststream.streamID }</td>
																	<td>${liststream.streamName}</td>
																	
																	<td>${liststream.streamDate}</td>
																	
																	<td>yes</td>
																	<td>
																		<a href="${pageContext.request.contextPath}/editStream.htm?streamID=${liststream.streamID}">
																			<i class="md md-create"></i>
																		</a>
																		<a href="${pageContext.request.contextPath}/deleteStream.htm?categoryID=${liststream.streamID}">
