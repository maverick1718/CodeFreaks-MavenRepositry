		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="pull-left page-title">Manage Degree</h4>
							<ol class="breadcrumb pull-right">
								<li><a
									href="index.jsp">CodeFreaks</a></li>
								<li>Manage Degree</li>
								<li class="active">View Degree</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">	
									<h3 class="panel-title">View Degree</h3>
								</div>
															...
															<thead>
																<tr role="row">
																	...
																	<th class="sorting" tabindex="0"
																		...
																		style="width: 100px;">Degree Name</th>
