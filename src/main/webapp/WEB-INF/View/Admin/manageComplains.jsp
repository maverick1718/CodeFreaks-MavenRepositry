					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb pull-right">
								...
								<li class="active">Manage Complains</li>
							</ol>
						</div>
					</div>
					<!-- Page-Title end -->
														...
														<table id="datatable"
															...
															<thead>
																<tr role="row">
																	<th class="sorting_asc" tabindex="0"
																		...
																		style="width: 50px;">Complain id</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Position: activate to sort column ascending"
																		style="width: 150px;">Author</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																	...
																	<th class="sorting" tabindex="0"
																		...
																		style="width: 150px;">Complain Subject</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Start date: activate to sort column ascending"
																		style="width: 70px;">Reply</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
															...
															<tbody>
																<tr role="row" class="odd">
																	...
																	<td></td>
																	<td></td>
																	<td><a href="managecomplains_reply.jsp">Reply</a></td>
																	<td></td>
