		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="pull-left page-title">Manege Complain Category</h4>
							<ol class="breadcrumb pull-right">
								<li><a
									href="index.jsp">CodeFreaks</a></li>
								<li>Manage Complain Category</li>
								<li class="active">Search Complain Category</li>
							</ol>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">	
									<h3 class="panel-title">Search Complain Category</h3>
								</div>
															...
															<thead>
																<tr role="row">
																	...
																	<th class="sorting" tabindex="0"
																		...
																		style="width: 100px;">Category Name</th>
