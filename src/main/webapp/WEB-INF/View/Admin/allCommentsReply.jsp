		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="pull-left page-title">Manage Comments</h4>
							<ol class="breadcrumb pull-right">
								<li><a href="index.jsp">CodeFreaks</a></li>
								<li><a href="managecomments.jsp">Manage Comments</a></li>
								<li class="active">Reply Comments</li>
							</ol>
						</div>
					</div>
					<!-- Page-Title end -->
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Reply Comments</h3>
								</div>
								...
								<div class="panel-body">
									...
									<form role="form">
										...
										<div class="form-group">
											<label for="categorydescription">Comment :</label>
