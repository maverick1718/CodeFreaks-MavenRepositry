							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form role="form">
										...
										<div class="form-group">
											<label for="categorydescription">Feedback :</label>
											<textarea class="form-control" rows="10" placeholder="Feedback"></textarea>
										</div>
										
										<div class="form-group">
											<label for="categorydescription">Rating :</label>
