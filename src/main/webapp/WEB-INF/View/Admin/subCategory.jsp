						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<form:form role="form" action="subCategory.htm" method="get" modelAttribute="addsubcategory">
										...
										<option value="${i.categoryID}"> ${i.categoryName}</option>
											...
											<form:input id="exampleInputEmail1" class="form-control"
												placeholder="Enter Subcategory Name" path="subCategoryName"/>
										</div>
										<div class="form-group">
											<label for="categorydescription">SubCategory Description :</label>
											<form:textarea class="form-control" rows="10" 
											placeholder="Write subcategory description" path="subCategoryDiscription"/></textarea>
										</div>
										<div class="form-group">
											<label for="exampleInputPassword1">Active :</label><br>
											<div class="radio radio-primary radio-inline">
												<form:radiobutton id="inlineRadio1"  checked="checked" name="radioInline" value="Yes" path="subCategoryStatus"/> 
												<label for="inlineRadio1">Yes</label>
											</div>
											<div class="radio radio-primary radio-inline">
												<form:radiobutton id="inlineRadio1" checked="checked" name="radioInline" value="No" path="subCategoryStatus"/> 
