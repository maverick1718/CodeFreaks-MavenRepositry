					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ol class="breadcrumb pull-right">
								...
								<li class="active">Manage Staff Problems</li>
							</ol>
						</div>
					</div>
					<!-- Page-Title end -->
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">Request Pending</h3>
								</div>
														...
														<table id="datatable"
															...
															<thead>
																<tr role="row">
																	<th class="sorting_asc" tabindex="0"
																		...
																		style="width: 90px;">Problem id</th>
																	...
																	<th class="sorting" tabindex="0"
																		...
																		style="width: 150px;">Problem Name</th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Age: activate to sort column ascending"
																		style="width: 57px;">Category</th>
																	...
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Salary: activate to sort column ascending"
																		style="width: 70px;">Approve</a></th>
																	<th class="sorting" tabindex="0"
																		aria-controls="datatable" rowspan="1" colspan="1"
																		aria-label="Salary: activate to sort column ascending"
																		style="width: 70px;">Disapprove</th>
															...
															<tbody>
																<tr role="row" class="odd">
																	...
																	<td></td>
																	<td></td>
																	<td><a href="managestaffpro_requestpending_view.jsp">view</a></td>
																	<td><a href="#"><i class="md md-done"></i></a></td>
